...
class NhanvienTableSeeder extends Seeder {
    ...
    public function run() {
            ...
            for ($j=0; $j < $employees[$i]; $j++, $count++) { 
                ...
                if ($i == 0) {
                    DB::table('nhacungcap')->insert([[
                        ...
                        'ncc_ten'       => "F-Shop.com",
                        'ncc_daiDien'   => $name,
                        'ncc_diaChi'    => "Khu 2 _DHCT",
                        'ncc_dienThoai' => "0969930917",
                        'ncc_email'     => "lmquan17005@gmail.com",
        ...
        array_push($list, [
            ...
            'nv_gioiTinh'  => true,
            'nv_email'     => "quanb1510856@gmail.com",
            'nv_ngaySinh'  => $today->format('Y-m-d H:i:s'),
            'nv_diaChi'    => "05 Vị Thắng - Vị Thủy - Hậu Giang",
            'nv_dienThoai' => "0969930917",
            'nv_taoMoi'    => $today->format('Y-m-d H:i:s'),
            'nv_capNhat'   => $today->format('Y-m-d H:i:s'),
            'q_ma'         => 2
        ]);
